...
movePlayer seconds (MkGameState ks s (MkPlayer _ _ (x,y) vel _ o oo) e _ _ _ _ r) = newGame
  where newGame | outOfViewBool (x,y) 900 600 = MkGameState ks s (MkPlayer "Flavius" 0 (outOfViewCoord (x,y) 900 600) vel 3 o oo) e [] Easy True False r
                | otherwise                   = MkGameState ks s (MkPlayer "Flavius" 0 (x,y) vel 3 o oo) e [] Easy True False r
