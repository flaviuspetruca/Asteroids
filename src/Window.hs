...
movePlayer seconds (MkGameState ks (MkPlayer _ gs im (x,y) vel l o oo) e b _ _ _ r) = newGame
  where newGame | outOfViewBool (x,y) 1000 700  = MkGameState ks (MkPlayer "Flavius" gs im (outOfViewCoord (x,y) 1000 700) vel l o oo) e b Easy True False r
                | otherwise                     = MkGameState ks (MkPlayer "Flavius" gs im (x,y) vel l o oo) e b Easy True False r
